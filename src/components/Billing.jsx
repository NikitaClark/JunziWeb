  ...
  <section id="product" className={layout.sectionReverse}>
    ...
    <h1 className="flex-1 font-poppins font-semibold ss:text-[55px] text-[52px] text-white ss:leading-[100.8px] leading-[10px]">
      ...
      <div className="services">
        <div className="flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[320px] md:mr-10 sm:mr-5 mr-0 my-3 feedback-card">
        <div className={`flex-1 flex ${styles.flexCenter} md:my-5 my-0 relative`}>
        <img src={csd} alt="billing" className="w-[20%] h-[80%]" />
        </div>
          <h2 className="font-poppins font-semibold text-white text-[26px] leading-[29.4px] mb-3">
        ...
        <div className="flex justify-between flex-col px-10 py-24 rounded-[20px]  max-w-[320px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
        <div className={`flex-1 flex ${styles.flexCenter} md:my-5 my-0 relative`}>
        ...
        <div className="flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[320px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
        <div className={`flex-1 flex ${styles.flexCenter} md:my-5 my-0 relative`}>
        <img src={ai} alt="billing" className="w-[20%] h-[80%]" />
        </div>
          <h2 className="font-poppins font-semibold text-white text-[26px] leading-[29.4px] mb-3">
        ...
        <div className="flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[320px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
        <div className={`flex-1 flex ${styles.flexCenter} md:my-5 my-0 relative`}>
        <img src={pai} alt="billing" className="w-[20%] h-[80%]" />
        </div>
          <h2 className="font-poppins font-semibold text-white text-[26px] leading-[29.4px] mb-3">
