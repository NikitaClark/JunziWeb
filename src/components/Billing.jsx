...
const Billing = () => (
  <section id="product" className={layout.sectionReverse}>
    ...
    <h1 className="flex-1 font-poppins font-semibold ss:text-[65px] text-[52px] text-white ss:leading-[100.8px] leading-[10px]">
      ...
      <div className="services">
        ...
        <img src={csd} alt="billing" className="w-[20%] h-[20%]" />
        </div>
        ...
        <img src={mad} alt="billing" className="w-[20%] h-[20%]" />
        </div>
          <h2 className="font-poppins font-semibold text-white text-[26px] leading-[29.4px] mb-3">
        ...
        <div className="service">
        <div className={`flex-1 flex ${styles.flexCenter} md:my-5 my-0 relative`}>
        <img src={qa} alt="billing" className="w-[20%] h-[20%]" />
        </div>
          <h2 className="font-poppins font-semibold text-white text-[26px] leading-[29.4px] mb-3">
            QA and Testing</h2>
          <p className="font-poppins font-normal text-dimWhite text-[19px] leading-[24px]">
        ...
        <div className="service">
        <div className={`flex-1 flex ${styles.flexCenter} md:my-5 my-0 relative`}>
        <img src={ux} alt="billing" className="w-[20%] h-[20%]" />
        </div>
          <h2 className="font-poppins font-semibold text-white text-[26px] leading-[29.4px] mb-3">
            UX/UI Design</h2>
          <p className="font-poppins font-normal text-dimWhite text-[19px] leading-[24px]">
        ...
        <div className="service">
        <div className={`flex-1 flex ${styles.flexCenter} md:my-5 my-0 relative`}>
        <img src={ai} alt="billing" className="w-[20%] h-[20%]" />
        </div>
          <h2 className="font-poppins font-semibold text-white text-[26px] leading-[29.4px] mb-3">
        ...
        <div className="service">
        <div className={`flex-1 flex ${styles.flexCenter} md:my-5 my-0 relative`}>
        <img src={pai} alt="billing" className="w-[20%] h-[20%]" />
        </div>
          <h2 className="font-poppins font-semibold text-white text-[26px] leading-[29.4px] mb-3">
