  ...
  <section className={layout.section}>
    ...
    <h1 className="flex-1 font-poppins font-semibold ss:text-[55px] text-[52px] text-white ss:leading-[100.8px] leading-[10px]">
      ...
      <div className="services">
        <div className="flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[250px] ">
        <div className={`flex-1 flex ${styles.flexCenter} md:my-5 my-0 relative`}>
        <img src={nikita} alt="billing" className="w-[100%] h-[100%]" />
        </div>
        ...
        <div className="flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[250px] ">
        <div className={`flex-1 flex ${styles.flexCenter} md:my-5 my-0 relative`}>
        <img src={alex} alt="billing" className="w-[100%] h-[100%]" />
        </div>
          <h2 className="font-poppins font-semibold text-white text-[26px] leading-[29.4px] mb-3">
        ...
        <div className="flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[250px] ">
        <div className={`flex-1 flex ${styles.flexCenter} md:my-5 my-0 relative`}>
        <img src={max} alt="billing" className="w-[100%] h-[100%]" />
        </div>
          <h2 className="font-poppins font-semibold text-white text-[26px] leading-[29.4px] mb-3">
          Maxim Onishenko</h2>
          <p className="font-poppins font-normal text-dimWhite text-[19px] leading-[24px]">
        ...
        <div className="flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[250px] ">
        <div className={`flex-1 flex ${styles.flexCenter} md:my-5 my-0 relative`}>
        <img src={anastasia} alt="billing" className="w-[100%] h-[100%]" />
        </div>
          <h2 className="font-poppins font-semibold text-white text-[26px] leading-[29.4px] mb-3">
